...
(function(w) {
  var s = {
    ...
    AccessibilityDisabledViewDataInstructions: "Press Shift+Enter to open the View Data window.",
    AccessibilityEmptyVizInstructions: "No data to visualize with current filters. To create a visualization and access the View Data Window, expand filters.",
    AccessibilityEnabledViewDataDisabled: "Press Enter to navigate through the marks on the visualization.",
    ...
    AccessibilityMarksAreaScreenReaderText: "Marks. {0}",
    AccessibilityNullCell: "No data.",
    ...
    AccessibilityViewDataInstructions: "Press Enter to navigate through the marks on the visualization, or press Shift+Enter to open the View Data window and navigate the marks in a table.",
    AccessibilityVizInTooltipsUnreadable: "There is an unreadable viz.",
    AccessibilityVizLevelNavigationScreenReaderText: "Use arrow keys to navigate data visualization elements.",
    ...
    AnalyticsAssistantTryMePopoverBodyText: "Don\'t know where to start? Einstein can help! Use generative AI to explore your data.",
    AnalyticsAssistantTryMePopoverTitle: "Analytics Assistant popover title",
    ...
    CategoricalLegendHighlighterButtonAriaLabel: "Highlight selected items in {0}",
    ...
    DataCatalogSevereLabelsAction: "Open Data Details",
    DataCatalogSevereLabelsToast: "Important quality warning and sensitivity labels affect the data used in this view.",
    DataCatalogSevereSensitivityToast: "Important sensitivity labels affect the data used in this view.",
    DataCatalogSevereWarningToast: "Important quality warning labels affect the data used in this view.",
    DataCloudSegmentError: "Unable to create segment on Data Cloud.",
    DataCloudSegmentViewInSalesforce: "View in Data Cloud",
    ...
    DataLakeObjects: "Data Lake Objects",
    ...
    DataModelObjects: "Data Model Objects",
    ...
    DatasourceReplaceKeychainErrorBodyMessage: "The data source can\'t be replaced due to a credential handling error. Contact your Tableau Administrator.",
    DatasourceReplaceKeychainErrorTitleMessage: "Unable to replace data source",
    December: "December",
    DecemberNarrow: "D",
    DecemberShort: "Dec",
    ...
    ECTButtonTitle: "Get help with Einstein",
    ...
    EmbeddedWorkbookTitle: "Workbook: {0}",
    ...
    ErrorPageClickRefresh: "Click the Refresh button in your web browser and try again.",
    ErrorPageContactTableauServer: "If you continue to receive this error please contact your Tableau Server Administrator.",
    ErrorPageErrorDetails: "An error occurred on the server.  The details of the error are:",
    ErrorPageHelpOnline: "You can also get help online from the <a href=\"{0}\"> Tableau Public Community.",
    ErrorPageUnexpectedError: "An unexpected error occurred on the server.&nbsp;&nbsp;Click the Refresh button in your web browser and try again.",
    ExitFullscreen: "Exit Full Screen",
    ExitFullscreenDescription: "Exit full screen",
    ExpandSchemaPane: "Expand",
    ExportCrosstabDialogMessage: "The data is ready to download.",
    ...
    FormatExternsionButtonLabel: "Format Extension",
    ...
    InstantAnalyticsErrorPageHeading: "The new workbook can\'t be created.",
    InstantAnalyticsGenericExceptionMessage: "Your analysis couldn\'t load. Head back to your Intelligent App and try again.",
    InstantAnalyticsUserRoleExceptionMessage: "You don\'t have access. Ask your Tableau admin to verify you are a Creator or Explorer on this site.",
    January: "January",
    JanuaryNarrow: "J",
    JanuaryShort: "Jan",
    July: "July",
    ...
    MaintenanceMessage: "Sorry, {0} is in <blink>Maintenance Mode<\/blink>",
    ...
    MobileAuthoringUnsupportedError: "Error:",
    MobileAuthoringUnsupportedFeatureUnavailable: "Editing is not supported in mobile browsers. Use a computer to edit in a browser or Tableau Desktop.",
    Monday: "Monday",
    MondayNarrow: "M",
    MondayShort: "Mon",
    ...
    PageNotFoundPleaseCheckUrlAndTryAgain: "Please check the URL and try again.",
    PageNotFoundResourceNotFound: "Resource not found",
    ...
    PublicErrorBrowseGallery: "In the meantime, you can browse this <a style=\"color: #177AD5;\" target=\"_top\" href=\"{0}\">Gallery<\/a> of other cool interactive views.",
    ...
    RelDateFilterInvalidDate: "Invalid relative date",
    ...
    RuntimeAccessibilityHeaderNodeFocusWithMargin: "Press Space to toggle selection. Press Escape to go back to the {0} margin. Use arrow keys to navigate headers",
    RuntimeAccessibilityHeaderNodeSelection: "Selected",
    ...
    SegmentsLearnMoreLink: "Learn more",
    ...
    ShowPageErrorNotFoundDetail: "The content you are looking for doesn\'t exist",
    ShowPageErrorNotFoundSummary: "Page unavailable",
    ShowPageErrorPublicContentNotFound: "The interactive content that usually shows here could not be found.&nbsp;It may have been removed or renamed.&nbsp;Please check back soon.",
    ShowPageErrorPublicWhereViz: "Where\'s the viz?",
    ShowPageErrorResourceLimitExceededDetail: "Computing the current visualization has exceeded the resource limit",
    ShowPageErrorResourceLimitExceededSummary: "Resource Limit Exceeded",
